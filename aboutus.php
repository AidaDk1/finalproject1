...
?>
    ...
    <div class="wide">
        ...
        <h3 style="color: red">About the food culture in Le cafe'</h3><p class="grey-text text-darken-3 lighten-3">This is the web application of  KyrgyzFood restaurant
